...
//
// Awin attribution: each deep link carries a `clickref=picker-<product>` label
// so per-product performance is visible in Awin reporting. clickref is a
...
// that tells those cards apart in reporting.
